...
// You can also use anything() in place of is(instanceOf(String.class))
    ...
    @Test
    public void testActivitySwitchCityConsistency(){
// Add a city
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Edmonton"));
        onView(withId(R.id.button_confirm)).perform(click());
    ...
    @Test
    public void testActivitySwitchAndReturn(){
// Add a city
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Edmonton"));
        onView(withId(R.id.button_confirm)).perform(click());
        ...
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("goatville"));
        onView(withId(R.id.button_confirm)).perform(click());
        ...
        onView(withId(R.id.textView)).check(matches((withText("Edmonton"))));
        this.getClass().getSimpleName().matches("ShowActivity");
        onView(withId(R.id.backButton)).perform(click());
        onData(is(instanceOf(String.class))).inAdapterView(withId(R.id.city_list
        )).atPosition(1).check(matches((withText("goatville"))));
